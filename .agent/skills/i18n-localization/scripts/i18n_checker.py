...
def check_hardcoded_strings(project_path: Path, enforce: bool) -> dict:
...
def main():
    ...
    enforce = len(locale_files) > 0
    code_result = check_hardcoded_strings(project_path, enforce=enforce)
    ...
    # Summary
    # If project doesn't ship locales, don't fail the build on i18n.
