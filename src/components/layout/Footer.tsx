        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="block">
              <img src="/logo.png" alt="DeLu Kids" className="h-16 w-auto brightness-0 invert opacity-90" />
            </Link>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://instagram.com/delukids_oficial" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-300">
              <li className="flex items-center gap-3">
                ...
                <span>(31) 99539-8002</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-brand-acid/20 flex items-center justify-center text-brand-acid">
                  <Mail className="w-4 h-4" />
                </div>
                <span>icarodev@arxsolutions.cloud</span>
              </li>
              <li className="pt-4">
                <a
                  href="https://wa.me/5531995398002"
                  target="_blank"
      ...
      <div className="border-t border-background/10">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-sm opacity-50">
            © 2026 DeLu Kids. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
